...
model = densenet_B.DenseNet(img_dim, classes=nb_classes, depth=depth, nb_dense_block=nb_dense_block, bottleneck=False, reduction=0.0,
...
trainX = densenet_B.preprocess_input(trainX)
testX = densenet_B.preprocess_input(testX)
...
out_dir_weight = "weights/approach_B.h5"
out_dir_logs = "logs/approach_B.log"
