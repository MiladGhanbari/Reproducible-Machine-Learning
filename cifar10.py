...
model = densenet.DenseNet(img_dim, classes=nb_classes, depth=depth, nb_dense_block=nb_dense_block, bottleneck=False, reduction=0.0,
...
out_dir_weight = "weights/40-12.h5"
out_dir_logs = "logs/40-12.log"
